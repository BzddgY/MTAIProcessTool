...
struct qt_meta_stringdata_CLASSColorbarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSColorbarENDCLASS = QtMocHelpers::stringData(
    "Colorbar"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSColorbarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Colorbar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSColorbarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSColorbarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSColorbarENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Colorbar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSColorbarENDCLASS.stringdata0))
