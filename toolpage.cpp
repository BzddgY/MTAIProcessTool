    ...
    m_pLabel(nullptr)
{
    ...
    m_pLabel->setPixmap(QPixmap(":/icon/down-arrow.png").scaled(m_pLabel->size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
...
void ToolPage::collapse()
{
    ...
    m_pLabel->setPixmap(QPixmap(":/icon/left-arrow.png").scaled(m_pLabel->size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
}
